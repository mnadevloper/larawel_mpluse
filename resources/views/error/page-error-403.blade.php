...
<!-- Mirrored from dompet.dexignlab.com/xhtml/page-error-403.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jul 2023 05:14:46 GMT -->
<head>
   <!-- All Meta -->
	<meta charset="utf-8">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-lg-6 col-sm-12">
                    <div class="form-input-content  error-page">
                        ...
                        <a class="btn btn-primary" href="{{ route('auth.index') }}">Back to Home</a>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
					<img  class="w-100 move-2" src="{{ asset('asset/images/error-media.png') }}" alt="">
				</div>
            </div>
        </div>
    </div>
