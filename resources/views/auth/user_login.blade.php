            ...
            <div class="row h-100">
				<div class="col-lg-6 col-md-12 col-sm-12 mx-auto align-self-center">
					<div class="login-form">
						...
						<form action="{{ route('auth.sign-in') }}" method="post" class="register-form">
                            @csrf
							...
							<div class="mb-4 position-relative">
								...
								<input type="password" id="dlab-password" class="form-control form-control" name="password" placeholder="Enter password">
