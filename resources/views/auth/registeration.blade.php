				...
				<div class="col-lg-6 col-md-12 col-sm-12 mx-auto align-self-center">
					<div class="login-form">
						<div class="text-center">
							...
							<p>Sign up to your account to start using Dompact</p>
						</div>
						<form action="{{ route('auth.sign-up') }}" method="post" class="register-form">
                            @csrf
							<div class="mb-4">
								<label class="mb-1 text-dark">Full Name</label>
								<input type="text" class="form-control form-control" name="username" id="username" value="{{ old('name') }}" placeholder="Enter full name" required>
                            ...
                            <div class="mb-4">
								...
								<input type="tel" class="form-control form-control" name="mobile" id="mobile"  value="{{ old('mobile') }}" required minlength="10" maxlength="10" placeholder="Enter contact number">
                                <span class="text-danger valid_err">
                                    @error('mobile')
                                    {{ $message }}
                                    @enderror
							...
							<div class="mb-4 position-relative">
								...
								<input type="password" id="dlab-password" class="form-control form-control" name="password" placeholder="Create password">
